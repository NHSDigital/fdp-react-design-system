...
export interface InternalSPCProps extends InternalSPCData, InternalSPCTargets, InternalSPCVisualOptions, InternalSPCAccessibilityOptions, InternalSPCAxisOptions, InternalSPCComputationOptions {
}
