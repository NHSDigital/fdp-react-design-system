...
import { useState as useState2, useRef as useRef2, useEffect, useMemo } from "react";
...
function TaskBar({
  ...
  const width = Math.max(rightPosition - leftPosition, 20);
  const getTaskColor = () => {
  ...
  const handleDoubleClick = () => {
    onTaskDoubleClick == null ? void 0 : onTaskDoubleClick(task);
  };
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "task-title", children: task.title }),
        task.progress !== void 0 && /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsx("span", { id: `task-${task.id}-details`, className: "sr-only", children: `Task: ${task.title}, from ${task.start.toLocaleDateString()} to ${task.end.toLocaleDateString()}${task.progress ? `, ${task.progress}% complete` : ""}${task.priority ? `, priority: ${task.priority}` : ""}` })
      ]
    }
  );
}
...
function GanttHeader({ viewStart, viewEnd, dateCount }) {
  const dates = [];
  ...
  const [focusedDateIndex, setFocusedDateIndex] = useState2(-1);
  ...
  const focusDateColumn = (index) => {
    var _a;
    const dateElement = (_a = headerRef.current) == null ? void 0 : _a.querySelector(`[data-date-index="${index}"]`);
    if (dateElement) {
      dateElement.focus();
    }
  };
      ...
      children: [
        ...
        /* @__PURE__ */ jsx2(
          "div",
          {
            ...
            children: dates.map((date2, idx) => {
              const isToday = date2.getTime() === today.getTime();
              ...
              return /* @__PURE__ */ jsx2(
                "div",
                {
                  ...
                  role: "button",
                  "aria-label": `${date2.toLocaleDateString("en-GB", {
                    weekday: "long",
                    day: "numeric",
                    month: "long",
                    year: "numeric"
                  ...
                  onKeyDown: handleKeyDown,
                  children: date2.toLocaleDateString("en-GB", {
                    day: "numeric",
                    month: "short"
                  })
                },
...
function GanttRow({ resource, tasks, scale, onTaskClick, onTaskDoubleClick, rowIndex, dateCount }) {
  const [isTimelineActive, setIsTimelineActive] = useState2(false);
  const [selectedTaskIndex, setSelectedTaskIndex] = useState2(-1);
  const timelineRef = useRef2(null);
  useEffect(() => {
    if (isTimelineActive && selectedTaskIndex >= 0 && tasks.length > 0) {
      setTimeout(() => {
        var _a;
        const selectedTask = (_a = timelineRef.current) == null ? void 0 : _a.querySelector(`[data-task-index="${selectedTaskIndex}"]`);
        selectedTask == null ? void 0 : selectedTask.focus();
      }, 0);
    }
  ...
  const handleTimelineKeyDown = (e) => {
    ...
    if (!isTimelineActive) {
      switch (e.key) {
        ...
        case "ArrowLeft":
          e.preventDefault();
          const resourceLabel = (_b = (_a = timelineRef.current) == null ? void 0 : _a.closest(".gantt-row")) == null ? void 0 : _b.querySelector(".resource-label");
          resourceLabel == null ? void 0 : resourceLabel.focus();
          break;
        case "Enter":
          if (tasks.length > 0) {
            e.preventDefault();
    ...
    switch (e.key) {
      case "ArrowLeft":
        ...
        const leftTask = (_c = timelineRef.current) == null ? void 0 : _c.querySelector(`[data-task-index="${newLeftIndex}"]`);
        leftTask == null ? void 0 : leftTask.focus();
        break;
      case "ArrowRight":
        e.preventDefault();
        const newRightIndex = Math.min(tasks.length - 1, selectedTaskIndex + 1);
        setSelectedTaskIndex(newRightIndex);
        const rightTask = (_d = timelineRef.current) == null ? void 0 : _d.querySelector(`[data-task-index="${newRightIndex}"]`);
        rightTask == null ? void 0 : rightTask.focus();
        break;
      case "Enter":
        e.preventDefault();
        if (selectedTaskIndex >= 0) {
          onTaskClick == null ? void 0 : onTaskClick(tasks[selectedTaskIndex]);
        }
        break;
      case " ":
        e.preventDefault();
        if (selectedTaskIndex >= 0) {
          onTaskDoubleClick == null ? void 0 : onTaskDoubleClick(tasks[selectedTaskIndex]);
        }
        break;
      case "Escape":
        e.preventDefault();
        ...
        (_e = timelineRef.current) == null ? void 0 : _e.focus();
        break;
    }
  };
  const handleResourceKeyDown = (e) => {
    ...
    switch (e.key) {
      ...
      case "ArrowRight":
        e.preventDefault();
        (_a = timelineRef.current) == null ? void 0 : _a.focus();
        break;
    }
  };
  const handleTaskFocus = (taskIndex) => {
    if (isTimelineActive) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx2(
          "div",
          {
            ...
            children: tasks.map((task, taskIndex) => /* @__PURE__ */ jsx2(
              TaskBar,
              {
                task,
                scale,
...
function GanttChart({
  ...
  const [timelineWidth, setTimelineWidth] = useState2(800);
  ...
  const timeScale = useMemo(
    () => time().domain([startDate, endDate]).range([0, timelineWidth]),
  ...
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      onKeyDown: handleKeyDown,
      children: [
        /* @__PURE__ */ jsx2(GanttHeader, { viewStart: startDate, viewEnd: endDate, dateCount }),
        /* @__PURE__ */ jsx2(
          "div",
          {
            ref: containerRef,
            ...
            onKeyDown: (e) => {
              ...
              if (e.key === "ArrowLeft" && e.altKey) {
                e.preventDefault();
                (_a = containerRef.current) == null ? void 0 : _a.scrollBy({ left: -50, behavior: "smooth" });
              } else if (e.key === "ArrowRight" && e.altKey) {
                e.preventDefault();
                (_b = containerRef.current) == null ? void 0 : _b.scrollBy({ left: 50, behavior: "smooth" });
              } else if (e.key === "ArrowUp" && e.altKey) {
                e.preventDefault();
                (_c = containerRef.current) == null ? void 0 : _c.scrollBy({ top: -50, behavior: "smooth" });
              } else if (e.key === "ArrowDown" && e.altKey) {
                e.preventDefault();
                (_d = containerRef.current) == null ? void 0 : _d.scrollBy({ top: 50, behavior: "smooth" });
              }
            },
            children: resources.map((resource, index) => /* @__PURE__ */ jsx2(
              GanttRow,
              {
                resource,
