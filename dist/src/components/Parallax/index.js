...
function generateShapes(props, sceneW) {
  ...
  while (shapes.length < count && attempts < count * 50) {
    ...
    const depth = clamp3(rng() * 1, 0.15, 0.95);
...
var ParallaxScene = (props) => {
  ...
  React.useEffect(() => {
    ...
    (async () => {
      ...
      if (!el) return;
      try {
        const gsapMod = await Promise.resolve().then(() => (init_gsap(), gsap_exports));
        const stMod = await Promise.resolve().then(() => (init_ScrollTrigger(), ScrollTrigger_exports));
        const gsap4 = (_b = (_a2 = gsapMod.default) != null ? _a2 : gsapMod.gsap) != null ? _b : gsapMod;
        const ScrollTrigger3 = (_d = (_c = stMod.ScrollTrigger) != null ? _c : stMod.default) != null ? _d : stMod;
        ...
        setScrollBase((prev) => {
          var _a3;
          return prev === null ? (_a3 = st.progress) != null ? _a3 : 0.5 : prev;
        });
        if (debugMarkers && window) {
          window.__parallaxRefresh = () => {
            try {
        ...
        const handler = () => {
          ...
          const visible = clamp3(traveled / total, 0, 1);
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("g", { className: "nhs-parallax-connectors", children: shapes.map((s, i) => {
                ...
                return corners.map((p2, j) => /* @__PURE__ */ jsx(
                  "line",
                  {
                    x1: clamp3(p2[0] + dx, 0, 100),
                    y1: clamp3(p2[1] + dy, 0, 100),
                    x2: clamp3(50 + dx * 0.2, 0, 100),
                    y2: clamp3(50 + dy * 0.2, 0, 100),
              ...
              /* @__PURE__ */ jsx("g", { className: "nhs-parallax-shapes", children: shapes.map((s, i) => {
                ...
                const dx = axis === "x" ? delta : axis === "xy" ? delta * diagVec.x : 0;
                const dy = axis === "y" ? delta : axis === "xy" ? delta * diagVec.y : 0;
                const tx = clamp3(s.x + dx, 0, 100);
                const ty = clamp3(s.y + dy, 0, 100);
