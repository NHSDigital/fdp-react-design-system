...
import React3, { useReducer, useCallback as useCallback3, useMemo as useMemo2, useRef as useRef2, useImperativeHandle, forwardRef as forwardRef2, useEffect, useState as useState2 } from "react";
...
var AriaTabsDataGrid = forwardRef2(
  function AriaTabsDataGrid2(props, ref) {
    ...
    const isDataEqual = useCallback3((data1, data2) => {
      return dataComparator(data1, data2);
    }, [dataComparator]);
    const handleTabSelect = useCallback3((index) => {
    ...
    const scrollTabIntoView = useCallback3((tabIndex, opts) => {
    ...
    const handleTabKeyDown = useCallback3((event, index) => {
      var _a, _b, _c, _d;
      const { key } = event;
      switch (key) {
        case "ArrowLeft":
    ...
    const handleSort = useCallback3((tabIndex, key) => {
      var _a;
    ...
    const focusGridHeader = useCallback3((headerIndex) => {
      setTimeout(() => {
    ...
    const renderBooleanIcon = useCallback3((value) => {
      return booleanRenderer(value);
    }, [booleanRenderer]);
    const focusGridCell = useCallback3((rowIndex, colIndex) => {
      setTimeout(() => {
    ...
    const handleHeaderKeyDown = useCallback3((event, headerIndex) => {
      var _a, _b;
      const { key } = event;
    ...
    const handleCellKeyDown = useCallback3((event, rowIndex, colIndex) => {
      const { key } = event;
      const currentPanel = tabPanels[state.selectedIndex];
    ...
    const getFilteredData = useCallback3((data, filters) => {
    ...
    if (isLoading) {
      return /* @__PURE__ */ jsx4("div", { className: `aria-tabs-datagrid aria-tabs-datagrid--loading ${className}`, "data-testid": dataTestId, children: loadingComponent || /* @__PURE__ */ jsx4("div", { className: "aria-tabs-datagrid__loading", children: /* @__PURE__ */ jsx4("div", { className: "nhsuk-spinner", role: "status", "aria-label": "Loading data", children: /* @__PURE__ */ jsx4("span", { className: "nhsuk-u-visually-hidden", children: "Loading..." }) }) }) });
    }
    if (error) {
      return /* @__PURE__ */ jsx4("div", { className: `aria-tabs-datagrid aria-tabs-datagrid--error ${className}`, "data-testid": dataTestId, children: errorComponent || /* @__PURE__ */ jsxs3("div", { className: "aria-tabs-datagrid__error", role: "alert", children: [
                ...
                children: isSelected && (() => {
                  ...
                  return /* @__PURE__ */ jsxs3(
                    "table",
                    {
                      ...
                      children: [
                        panel.ariaDescription && /* @__PURE__ */ jsx4("caption", { className: "nhsuk-u-visually-hidden", id: `panel-${panel.id}-description`, children: panel.ariaDescription }),
                          ...
                          return /* @__PURE__ */ jsx4(
                            "th",
                            {
                              ...
                              children: /* @__PURE__ */ jsxs3("div", { className: "header-content", children: [
                                ...
                                /* @__PURE__ */ jsxs3("div", { className: `sort-indicator-container ${isSorted ? `sort-indicator--${sortInfo == null ? void 0 : sortInfo.direction}` : ""}`, children: [
                                  state.sortConfig && state.sortConfig.length > 0 && state.sortConfig.findIndex((config) => config.key === column.key) !== -1 && /* @__PURE__ */ jsx4(
                                    "span",
                                    {
                              ...
                              children: panel.columns.map((column, colIndex) => {
                                ...
                                const renderValue = () => {
                                  if (column.customRenderer) {
                                    ...
                                    return /* @__PURE__ */ jsx4("span", { className: "data-cell__custom", "data-custom-rendered": "true", children: rendered });
                                  }
...
var ResponsiveDataGrid = ({
  ...
  if (layout === "hybrid") {
    return /* @__PURE__ */ jsx10("div", { className: `aria-tabs-datagrid-adaptive aria-tabs-datagrid-adaptive--hybrid ${className || ""}`, children: /* @__PURE__ */ jsx10(
      AriaTabsDataGrid,
      {
        tabPanels,
        dataConfig,
