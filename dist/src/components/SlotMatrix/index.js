...
var Row = ({
  ...
  const rowClasses = (0, import_classnames2.default)(
    "nhsuk-grid-row",
...
var Grid = ({
  ...
  if (hasRowAsFirstChild) {
    content = childrenArray.map((child, idx) => {
      ...
      return React2.cloneElement(el, { style: mergedStyle });
    });
  } else {
    const implicitRowStyle = { marginTop: void 0 };
    content = /* @__PURE__ */ jsx6(Row, { style: implicitRowStyle, children });
  }
  return /* @__PURE__ */ jsx6(Container, { className, style, ...props, children: content });
};
