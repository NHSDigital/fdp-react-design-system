...
var TableBase = ({
  ...
  const renderHeaderCell = (cell, index) => {
    ...
    let content;
    if (cell.node != null) {
      content = /* @__PURE__ */ jsx3(Fragment, { children: cell.node });
    } else if (cell.html) {
      content = /* @__PURE__ */ jsx3("span", { dangerouslySetInnerHTML: { __html: cell.html } });
  ...
  const renderCell = (cell, cellIndex, isFirstCell) => {
    ...
    let inner;
    if (cell.node != null) {
      inner = /* @__PURE__ */ jsx3(Fragment, { children: cell.node });
    } else if (cell.html) {
      inner = /* @__PURE__ */ jsx3("span", { dangerouslySetInnerHTML: { __html: cell.html } });
    } else if (cell.code != null) {
      const isArray = Array.isArray(cell.code);
      const codeString = isArray ? cell.code.join("\n") : cell.code;
      const isMultiline = isArray || codeString.includes("\n");
