...
var Account = ({
    ...
    if (item.action) {
      return /* @__PURE__ */ jsx2(
        "form",
        {
          ...
          children: /* @__PURE__ */ jsx2("button", { className: "nhsuk-account__button", type: "submit", role: "button", children: content })
        }
      );
    }
  ...
  return /* @__PURE__ */ jsx2(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsx2("ul", { className: "nhsuk-account__list", children: items.map(
        (item, index) => item && /* @__PURE__ */ jsx2(
          "li",
          {
            className: (0, import_classnames2.default)(
...
function renderHeaderMarkup(props, {
  ...
  const effectiveService = {
    ...service,
    text: (_a = service == null ? void 0 : service.text) != null ? _a : serviceName
  };
  ...
  const renderOrganisationName = () => organisation ? /* @__PURE__ */ jsxs2(Fragment2, { children: [
    /* @__PURE__ */ jsxs2("span", { className: "nhsuk-header__organisation-name", children: [
      organisation.name,
      organisation.split && /* @__PURE__ */ jsxs2("span", { className: "nhsuk-header__organisation-name-split", children: [
        " ",
        organisation.split
      ] })
    ] }),
  ...
  const renderServerSearch = () => {
    ...
    return /* @__PURE__ */ jsx3("div", { className: (0, import_classnames3.default)("nhsuk-header__search", searchClassName), children: /* @__PURE__ */ jsxs2(
      "form",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx3("div", { className: "nhsuk-header__search-input-wrapper", children: /* @__PURE__ */ jsx3(
            "input",
            {
          ...
          /* @__PURE__ */ jsx3("button", { className: "nhsuk-header__search-submit", type: "submit", ...buttonAttributes, children: /* @__PURE__ */ jsx3("span", { className: "nhsuk-u-visually-hidden", children: visuallyHiddenButton }) })
        ]
      }
    ) });
  };
    ...
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs2("div", { className: containerClass, children: [
          /* @__PURE__ */ jsxs2("div", { className: "nhsuk-header__service", children: [
            logoHref ? /* @__PURE__ */ jsxs2("a", { className: "nhsuk-header__service-logo", href: logoHref, children: [
              renderServiceLogo(),
          ...
          variant === "client" ? searchNode != null ? searchNode : null : renderServerSearch(),
          /* @__PURE__ */ jsx3(
            Account,
            {
              ...account,
                ...
                children: /* @__PURE__ */ jsxs2(
                  "ul",
                  {
                    ...
                    children: [
                      ...
                      variant === "client" && showMoreButton && visibleItems !== void 0 && /* @__PURE__ */ jsx3("li", { className: "nhsuk-header__navigation-item nhsuk-header__navigation-item--more", children: /* @__PURE__ */ jsxs2(
                        "button",
                        {
...
var HeaderSearch = ({
  ...
  const renderSearchIcon = () => /* @__PURE__ */ jsx5(
    "svg",
    {
      className: (0, import_classnames4.default)("nhsuk-icon nhsuk-icon__search", {
      ...
      "aria-hidden": "true",
      focusable: "false",
      children: /* @__PURE__ */ jsx5("path", { d: "M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z" })
    }
  );
  const renderLoadingSpinner = () => /* @__PURE__ */ jsx5(
    "svg",
    {
      ...
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx5(
          "svg",
          {
            ...
            "aria-hidden": "true",
            focusable: "false",
            children: /* @__PURE__ */ jsx5("path", { d: "M13.41 12l5.3-5.29a1 1 0 1 0-1.42-1.42L12 10.59l-5.29-5.3a1 1 0 0 0-1.42 1.42l5.3 5.29-5.3 5.29a1 1 0 0 0 1.42 1.42l5.29-5.3 5.29 5.3a1 1 0 0 0 1.42-1.42z" })
          }
        )
      }
    );
  ...
  const renderResults = () => {
    ...
    return /* @__PURE__ */ jsx5("div", { className: "nhsuk-header__search-results", role: "listbox", children: results.map((result) => /* @__PURE__ */ jsx5(
      "div",
      {
        ...
        children: result.href ? /* @__PURE__ */ jsxs3(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsx5("span", { className: "nhsuk-header__search-result-title", children: result.title }),
              result.description && /* @__PURE__ */ jsx5("span", { className: "nhsuk-header__search-result-description", children: result.description })
            ]
          }
        ) : /* @__PURE__ */ jsxs3(
          "button",
      ...
      children: [
        /* @__PURE__ */ jsxs3(
          "form",
          {
            ...
            ...formAttributes,
            children: [
              /* @__PURE__ */ jsx5("label", { className: "nhsuk-u-visually-hidden", htmlFor: "search-field", children: visuallyHiddenLabel }),
              ...
              /* @__PURE__ */ jsxs3(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx5("span", { className: "nhsuk-u-visually-hidden", children: isLoading ? "Searching..." : visuallyHiddenButton })
                  ]
                }
              )
            ]
...
var Header = ({
  ...
  return renderHeaderMarkup(
    ...
    },
    {
      ...
      searchNode: search ? /* @__PURE__ */ jsx6(HeaderSearch, { ...search }) : null,
...
var Container = ({
  ...
  return /* @__PURE__ */ jsx7("div", { className: containerClasses, style: mergedStyle, ...props, children });
};
var Row = ({
  children,
  className,
  ...
  return /* @__PURE__ */ jsx7("div", { className: rowClasses, style, ...props, children });
};
var Column = ({
  children,
  width = "full" /* Full */,
  ...
  return /* @__PURE__ */ jsx7("div", { className: columnClasses, style, ...props, children });
};

// src/components/WidthContainer/WidthContainer.tsx
import { jsx as jsx8 } from "react/jsx-runtime";
var WidthContainer = (props) => {
  return /* @__PURE__ */ jsx8(Container, { ...props });
};
...
var MainWrapper = ({
  ...
  return /* @__PURE__ */ jsx9(Component, { className: classes, ...props, children });
};
...
var Footer = ({
  ...
  const renderLinkItem = (item, isDefaultLayout = false) => /* @__PURE__ */ jsx11(
    "li",
    {
  ...
  return /* @__PURE__ */ jsx11("footer", { role: "contentinfo", ...attributes, style: { ...attributes == null ? void 0 : attributes.style, ...style }, children: /* @__PURE__ */ jsxs4("div", { className: "nhsuk-footer-container", children: [
    /* @__PURE__ */ jsxs4(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx11("h2", { className: "nhsuk-u-visually-hidden", children: "Support links" }),
          /* @__PURE__ */ jsx11("div", { className: (0, import_classnames6.default)("nhsuk-footer", className), style: footerStyle, children: !isMultiColumnLayout ? (
            ...
            /* @__PURE__ */ jsxs4(Fragment3, { children: [
              links.length > 0 && /* @__PURE__ */ jsx11("ul", { className: "nhsuk-footer__list", children: links.map((item) => renderLinkItem(item)) }),
              linksColumn2 && linksColumn2.length > 0 && /* @__PURE__ */ jsx11("ul", { className: "nhsuk-footer__list", children: linksColumn2.map((item) => renderLinkItem(item)) }),
              linksColumn3 && linksColumn3.length > 0 && /* @__PURE__ */ jsx11("ul", { className: "nhsuk-footer__list", children: linksColumn3.map((item) => renderLinkItem(item)) }),
              metaLinks && metaLinks.length > 0 && /* @__PURE__ */ jsx11("ul", { className: "nhsuk-footer__list nhsuk-footer__meta", children: metaLinks.map((item) => renderLinkItem(item)) })
            ] })
          ) }),
          !isMultiColumnLayout && /* @__PURE__ */ jsx11("div", { children: /* @__PURE__ */ jsx11("p", { className: "nhsuk-footer__copyright", children: copyright }) })
        ]
      }
    ),
    isMultiColumnLayout && /* @__PURE__ */ jsx11("div", { className: "nhsuk-width-container", children: /* @__PURE__ */ jsx11("div", { children: /* @__PURE__ */ jsx11("p", { className: "nhsuk-footer__copyright", children: copyright }) }) })
  ] }) });
};
...
var BackLink = ({
  ...
  const containerClasses = (0, import_classnames7.default)(
    "nhsuk-back-link",
    className
  );
  const linkClasses = (0, import_classnames7.default)(
    ...
    return /* @__PURE__ */ jsxs5(Fragment4, { children: [
      /* @__PURE__ */ jsx12(
        "svg",
        {
          ...
          height: "24",
          width: "24",
          children: /* @__PURE__ */ jsx12("path", { d: "M8.5 12c0-.3.1-.5.3-.7l5-5c.4-.4 1-.4 1.4 0s.4 1 0 1.4L10.9 12l4.3 4.3c.4.4.4 1 0 1.4s-1 .4-1.4 0l-5-5c-.2-.2-.3-.4-.3-.7z" })
        }
      ),
      html ? /* @__PURE__ */ jsx12("span", { dangerouslySetInnerHTML: { __html: html } }) : text
    ] });
  };
  return /* @__PURE__ */ jsx12("div", { className: containerClasses, children: element === "button" ? /* @__PURE__ */ jsx12(
    "button",
    {
...
var TransactionalPageTemplate = ({
  ...
  return /* @__PURE__ */ jsxs6(Fragment5, { children: [
    /* @__PURE__ */ jsx13(SkipLink, { ...skipLinkProps }),
    /* @__PURE__ */ jsx13(Header, { ...headerConfig }),
    /* @__PURE__ */ jsxs6(WidthContainer, { className, ...containerProps, children: [
      backLinkProps && /* @__PURE__ */ jsx13(BackLink, { ...backLinkProps }),
      /* @__PURE__ */ jsx13(MainWrapper, { size: mainWrapperSize, children: /* @__PURE__ */ jsx13(Row, { children: /* @__PURE__ */ jsxs6(Column, { width: columnWidth, children: [
        title && /* @__PURE__ */ jsx13(Heading, { style: { marginTop: "3rem" }, size: "l", ...pageHeadingProps, children: title }),
        children
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsx13(Footer, { ...footerProps })
  ] });
};
