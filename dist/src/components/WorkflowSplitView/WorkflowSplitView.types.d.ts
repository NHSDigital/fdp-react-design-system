...
export interface WorkflowSplitViewProps<ID = string, T extends WorkflowStep<ID> = WorkflowStep<ID>> {
    ...
    renderStepContent: (step: T | undefined, section?: WorkflowSection<ID>) => React.ReactNode;
    renderSecondaryContent?: (step: T | undefined, section?: WorkflowSection<ID>) => React.ReactNode;
    renderSecondaryNav?: (step: T | undefined, sections?: WorkflowSection<ID>[], activeSection?: WorkflowSection<ID>, onSelectSection?: (sectionId: ID) => void) => React.ReactNode;
    layoutForStep?: (args: {
        step: T;
        index: number;
