...
function Ce(t, { isClient: a, brand: r }) {
  ...
  const y = {
    ...
    return M();
  }, C = () => i ? /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement("span", { className: "nhsuk-header__organisation-name" }, i.name, i.split && /* @__PURE__ */ e.createElement("span", { className: "nhsuk-header__organisation-name-split" }, " ", i.split)), i.descriptor && /* @__PURE__ */ e.createElement("span", { className: "nhsuk-header__organisation-name-descriptor" }, i.descriptor)) : null, D = (v, j) => v ? j ? /* @__PURE__ */ e.createElement("a", { className: "nhsuk-header__service-name", href: j }, v) : /* @__PURE__ */ e.createElement("span", { className: "nhsuk-header__service-name" }, v) : null, T = (v) => v.active || v.current ? /* @__PURE__ */ e.createElement("strong", { className: "nhsuk-header__navigation-item-current-fallback" }, v.html ? /* @__PURE__ */ e.createElement("span", { dangerouslySetInnerHTML: { __html: v.html } }) : v.text) : v.html ? /* @__PURE__ */ e.createElement("span", { dangerouslySetInnerHTML: { __html: v.html } }) : v.text;
  return /* @__PURE__ */ e.createElement(e.Fragment, null, /* @__PURE__ */ e.createElement(
    ...
    o && o.items && o.items.length > 0 && /* @__PURE__ */ e.createElement(
      ...
      /* @__PURE__ */ e.createElement(
        ...
        /* @__PURE__ */ e.createElement("ul", { className: "nhsuk-header__navigation-list" }, o.items.map((v, j) => /* @__PURE__ */ e.createElement(
          "li",
          {
            key: j,
            className: w(
...
const Ct = ({
  ...
  const y = S.useId(), N = b || y, E = `${N}-label`, x = `${N}-value`, I = `${N}-delta`, _ = typeof a == "number" && !Number.isNaN(a), L = o ? "—" : h ? "" : _ ? f ? f(a) : a.toLocaleString() : a;
  let M, m = "", C = "";
  if (n && !o && !h) {
    M = n.direction || (n.value > 0 ? "up" : n.value < 0 ? "down" : "neutral");
    const D = Math.abs(n.value), T = M === "up" ? `+${D}` : M === "down" ? `-${D}` : "0", v = n.isPercent ? "%" : "";
    if (m = `${T}${v}`, n.ariaLabel)
      C = n.ariaLabel;
    else {
      const j = n.invert ? M === "down" : M === "up";
      C = `${M === "neutral" ? "no change" : M === "up" ? "up" : "down"} ${D}${v}${M === "neutral" ? "" : j ? " (improvement)" : " (worse)"}`;
    }
  }
  return /* @__PURE__ */ S.createElement(
    "div",
  ...
  const y = `nhsuk-table__caption ${n ? `nhsuk-table__caption--${n}` : ""}`.trim(), N = w(
    ...
    let v;
    if (m.node != null)
      v = /* @__PURE__ */ e.createElement(e.Fragment, null, m.node);
    else if (m.html)
      v = /* @__PURE__ */ e.createElement("span", { dangerouslySetInnerHTML: { __html: m.html } });
    else if (m.code != null) {
      const j = Array.isArray(m.code), A = j ? m.code.join(`
`) : m.code, z = j || A.includes(`
`), Z = {
      ...
      v = z ? /* @__PURE__ */ e.createElement("pre", { className: "nhsuk-table__pre" }, /* @__PURE__ */ e.createElement(
        "code",
        {
          ...Z,
      ...
      v = m.text;
    return /* @__PURE__ */ e.createElement("th", { key: C, className: D, ...T }, v);
  }, I = (m, C, D) => {
    const T = s && D || m.rowHeader, v = w(
...
`), F = {
    ...
    return /* @__PURE__ */ e.createElement(Z, { key: C, className: v, ...j }, z);
  };
  let _ = a, L = t;
  !_ && b && b.length && (_ = b.map((m) => ({
    ...
    let v = { format: D.format, classes: D.cellClasses, attributes: D.cellAttributes };
    if (D.rowHeader && (v.rowHeader = !0), D.render) {
      const j = D.render(T, m, C, D);
      return j == null || typeof j == "boolean" ? { ...v, text: "" } : typeof j == "string" || typeof j == "number" ? { ...v, text: String(j) } : { ...v, ...j };
    }
    return { ...v, text: T != null ? String(T) : "" };
  })));
  ...
  return d ? /* @__PURE__ */ e.createElement(Oe, { className: o }, c && /* @__PURE__ */ e.createElement(H, { level: i, className: "nhsuk-table__heading-tab" }, c), M()) : E ? /* @__PURE__ */ e.createElement("div", { className: E }, M()) : M();
}, Xe = ({
  children: t,
  size: a,
  className: r
...
function at(t, a, r = 4) {
  const n = tt(t), s = [], l = ["rect", "hex", "circle"], c = Q.indexOf(a), i = [
    ...
    Q[(c + 2) % Q.length],
    Q[(c + 3) % Q.length]
  ], d = [], o = 1200, h = 400, f = 1.2, g = (y, N) => !(y.right < N.left || y.left > N.right || y.bottom < N.top || y.top > N.bottom), u = (y) => y.left >= 0 && y.top >= 0 && y.right <= 100 && y.bottom <= 100, b = (y, N, E, x, I, _) => {
    let L = 0, M = 0;
    if (y === "rect") {
      const m = x ?? 48, C = I ?? 36;
      L = m / o * 100, M = C / h * 100;
  ...
  for (; s.length < k && p < k * 120; ) {
    p++;
    const y = l[Math.floor(n() * l.length)], N = K(20 + n() * 60, 10, 90), E = K(20 + n() * 60, 10, 90), x = i[Math.floor(n() * i.length)], I = s.length < 2 ? "soft" : "none";
    if (y === "rect") {
      const _ = 40 + n() * 80, L = 28 + n() * 64, M = b(y, N, E, _, L);
      if (!u(M)) continue;
      let m = !1;
      ...
      const _ = 24 + n() * 80, L = b(y, N, E, void 0, void 0, _);
      if (!u(L)) continue;
      let M = !1;
      ...
      const _ = 28 + n() * 72, L = n() * 360, M = b(y, N, E, void 0, void 0, _);
      if (!u(M)) continue;
      let m = !1;
      for (let C = 0; C < d.length; C++)
        if (g(M, d[C])) {
...
const At = ({
  ...
  const { classes: M, describedBy: m } = st({ hasError: d, resize: k, className: h, describedBy: o });
  return /* @__PURE__ */ e.createElement(
    "textarea",
    {
      className: M,
...
const ct = ({
  ...
  const { classes: E } = lt({ hasError: i, className: o }), x = () => u ? u.map((_, L) => /* @__PURE__ */ e.createElement(
    "option",
    {
      key: `${_.value}-${L}`,
      value: _.value,
...
function zt({
  ...
  const p = w("nhsuk-form-group", {
    ...
    f.map((N) => {
      ...
      return /* @__PURE__ */ e.createElement("div", { key: N.name, className: "nhsuk-date-input__item" }, /* @__PURE__ */ e.createElement(te, { htmlFor: E, className: "nhsuk-date-input__label" }, I), /* @__PURE__ */ e.createElement(
        ne,
        {
          id: E,
          name: x,
...
function ut(t, {
  ...
  const {
    ...
    options: x,
    ...I
  } = u, { classes: _, describedBy: L } = dt({ hasError: p, size: N, inline: E, className: y, describedBy: k });
  return /* @__PURE__ */ e.createElement(ae, null, /* @__PURE__ */ e.createElement(
    ...
    x.map((M, m) => {
      const C = `${b}-${m}`, D = M.conditional ? `${C}-conditional` : void 0, T = r === M.value;
...
function Ht(t) {
  const {
    ...
    attributes: u,
    ...b
  } = t, p = n || r, k = i ? `${p}-hint` : void 0, y = d ? `${p}-error` : void 0, N = [k, y].filter(Boolean).join(" ") || void 0, { classes: E, formGroupClasses: x } = mt({ small: h, className: o, hasError: !!d });
