...
- `@fergusbisset/nhs-fdp-design-system/meta/components.json`
...
import manifest from '@fergusbisset/nhs-fdp-design-system/meta/components.json';
...
const res = await fetch('/node_modules/@fergusbisset/nhs-fdp-design-system/dist/meta/components.json');
