...
- `@nhsdigital/nhs-fdp-design-system/meta/components.json`
...
import manifest from '@nhsdigital/nhs-fdp-design-system/meta/components.json';
...
const res = await fetch('/node_modules/@nhsdigital/nhs-fdp-design-system/dist/meta/components.json');
