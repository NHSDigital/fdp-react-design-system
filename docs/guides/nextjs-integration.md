...
'use client';
import { NavigationSplitView } from '@nhsdigital/fdp-design-system';
...
```tsx
import '@nhsdigital/fdp-design-system/styles/fonts.css';
```
...
| Styles missing in prod | Global CSS not imported in `layout.tsx` | Import `@nhsdigital/fdp-design-system/nextjs` |
