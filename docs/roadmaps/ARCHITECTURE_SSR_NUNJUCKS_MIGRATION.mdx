...
- Next.js example `/ssr` route imports only from `/ssr` (guarded by ESLint). SSR tests green (52 files / 177 tests), smoke green, parity build passing; typecheck and lint clean.
