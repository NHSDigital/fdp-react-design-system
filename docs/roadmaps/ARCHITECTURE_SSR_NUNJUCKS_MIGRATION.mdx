...
- Introduced a curated SSR export surface at `@fergusbisset/nhs-fdp-design-system/ssr` containing only hook‑free components.
...
useEffect(() => {
  ...
  import('@fergusbisset/nhs-fdp-design-system/behaviours').then(({ initAll, teardownAll }) => {
    initAll(ref.current ?? document);
  });
  return () => {
    // Optional: narrowed detach
    import('@fergusbisset/nhs-fdp-design-system/behaviours').then(({ teardownAll }) => {
...
import "@fergusbisset/nhs-fdp-design-system/components/Details/css";
import "@fergusbisset/nhs-fdp-design-system/components/InsetText/css";
import "@fergusbisset/nhs-fdp-design-system/components/Panel/css";
import "@fergusbisset/nhs-fdp-design-system/components/List/css";
import "@fergusbisset/nhs-fdp-design-system/components/SummaryList/css";
import "@fergusbisset/nhs-fdp-design-system/components/SummaryCard/css";
import "@fergusbisset/nhs-fdp-design-system/components/Tables/Table/css";
import "@fergusbisset/nhs-fdp-design-system/components/Hero/css";
import "@fergusbisset/nhs-fdp-design-system/components/CareCard/css";
import "@fergusbisset/nhs-fdp-design-system/components/Pagination/css";
import "@fergusbisset/nhs-fdp-design-system/components/Input/css";
import "@fergusbisset/nhs-fdp-design-system/components/Textarea/css";
import "@fergusbisset/nhs-fdp-design-system/components/Select/css";
import "@fergusbisset/nhs-fdp-design-system/components/DateInput/css";
import "@fergusbisset/nhs-fdp-design-system/components/ErrorSummary/css";
import "@fergusbisset/nhs-fdp-design-system/components/Radios/css";
import "@fergusbisset/nhs-fdp-design-system/components/Checkboxes/css";
import "@fergusbisset/nhs-fdp-design-system/components/Fieldset/css";
import "@fergusbisset/nhs-fdp-design-system/components/FormNavButtonBar/css";
import "./globals.css";
...
import { ButtonServer } from '@fergusbisset/nhs-fdp-design-system/components/Button/server';
...
- Introduced curated SSR export surface at `@fergusbisset/nhs-fdp-design-system/ssr`.
