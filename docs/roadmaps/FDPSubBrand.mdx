...
@import '@nhsdigital/fdp-design-system/styles/tokens/semantics.css';

/* FDP brand overlay (scoped to [data-brand="fdp"]) */
@import '@nhsdigital/fdp-design-system/styles/tokens/brand-fdp.css';
```
...
import { BrandThemeProvider } from '@nhsdigital/fdp-design-system';
...
Where to find them:
- CSS overlay variables: `@nhsdigital/fdp-design-system/styles/tokens/brand-fdp.css`
- Default semantics: `@nhsdigital/fdp-design-system/styles/tokens/semantics.css`
...
import gradients from '@nhsdigital/fdp-design-system/dist/js/gradients.json';
...
// @use '@nhsdigital/fdp-design-system/packages/nhs-fdp/dist/scss/gradients' as nhs;
