...
@import '@fergusbisset/nhs-fdp-design-system/styles/tokens/semantics.css';

/* FDP brand overlay (scoped to [data-brand="fdp"]) */
@import '@fergusbisset/nhs-fdp-design-system/styles/tokens/brand-fdp.css';
```
...
import { BrandThemeProvider } from '@fergusbisset/nhs-fdp-design-system';
...
Where to find them:
- CSS overlay variables: `@fergusbisset/nhs-fdp-design-system/styles/tokens/brand-fdp.css`
- Default semantics: `@fergusbisset/nhs-fdp-design-system/styles/tokens/semantics.css`
...
import gradients from '@fergusbisset/nhs-fdp-design-system/dist/js/gradients.json';
...
// @use '@fergusbisset/nhs-fdp-design-system/packages/nhs-fdp/dist/scss/gradients' as nhs;
...
- A toolbar toggle sets the brand for stories via our `BrandThemeProvider`.
- You can preview both NHS and FDP look-and-feel without restarting Storybook.
...
This page will evolve as we add more FDP-specific tokens and patterns (e.g., data viz palettes, chart helpers, component examples). If you need a specific token or example, open an issue or ping in the design system channel.
