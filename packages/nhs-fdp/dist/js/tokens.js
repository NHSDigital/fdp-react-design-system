...
export const BreakpointMobileMax = "767px"; // Maximum mobile breakpoint
export const BreakpointTablet = "641px"; // Tablet breakpoint
export const BreakpointTabletStandard = "768px"; // Standard tablet breakpoint used in components
export const BreakpointDesktop = "1025px"; // Desktop breakpoint
export const BreakpointDesktopLarge = "1280px"; // Large desktop breakpoint
export const BreakpointDesktopXl = "1200px"; // Extra large desktop breakpoint used in components
