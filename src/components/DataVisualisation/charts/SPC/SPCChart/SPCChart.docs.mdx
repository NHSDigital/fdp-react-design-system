...
<Table
  ...
  rows={[
    ...
    [
      { code: 'enableTrendSideGating', codeLanguage: 'typescript' },
      { text: 'Enables trend side-gating: early trend points on the unfavourable side remain neutral until trend crosses mean (reduces premature concern/improvement labelling).', codeLanguage: 'typescript' },
      { code: 'boolean', codeLanguage: 'typescript' },
      { code: 'false', codeLanguage: 'typescript' },
    ],
  ]}
