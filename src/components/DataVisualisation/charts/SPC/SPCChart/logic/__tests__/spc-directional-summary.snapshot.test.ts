...
import { buildSpc, ChartType, ImprovementDirection, getDirectionalSignalSummary } from '../spc';
...
describe('getDirectionalSignalSummary snapshot', () => {
  it('produces expected summary structure for mixed directional dataset', () => {
    ...
    const values = [
      10,10,10,10,10,10,10, // stable
      20,20,20,20,20,20,20, // sustained high -> shift up
      5,                     // single extreme low -> single point down
      12,13,14,15,16,17      // monotonic up -> trend up
    ];
