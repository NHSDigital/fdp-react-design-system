...
Note: Trend side-gating is always enabled in the core engine. The SQL compatibility wrapper no longer accepts a flag to disable it; parity analysis should focus on rank/pruning transparency rather than mutating core semantics.
