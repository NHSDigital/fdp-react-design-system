...
import { metricLookup } from "../../test-data/parsedDataset.ts";
...
const meta: Meta = {
	...
	// Disable this legacy duplicate in favor of the canonical v1 story in SPCChart/.
	// Keeping the file for reference and tests, but exclude all stories from indexing.
	includeStories: [],
	parameters: {
		docs: {
			description: {
