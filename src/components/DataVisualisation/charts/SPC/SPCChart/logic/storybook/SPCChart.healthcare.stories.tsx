...
import { SPCChart, ImprovementDirection, type SPCDatum } from "../../SPCChart.tsx";
import { ChartContainer } from "../../../../ChartContainer.tsx";
import { ChartType } from "../spcConstants.ts";
import { buildSpcSqlCompat } from "../spcSqlCompat.ts";
...
const meta: Meta<typeof SPCChart> = {
	title: "Data Visualisation/SPC/v1/Healthcare Examples",
	component: SPCChart,
	includeStories: [],
	parameters: {
		docs: {
