...
import { SPCChart, type SPCDatum, ImprovementDirection, SequenceTransition, TrendVisualMode } from "../../SPCChart.tsx";
import { ruleGlossary } from "../spcDescriptors.ts";
import React from "react";
import { seedPRNG } from "../../../../../stories/utils/deterministic.ts";
import { ChartContainer } from "../../../../ChartContainer.tsx";
// Use top-level component barrel for Heading/Table/List (navigate up to components root)
import { Heading, Table, List } from "../../../../../../index.ts";
import { ChartType } from '../spcConstants.ts';

const meta: Meta<typeof SPCChart> = {
	title: "Data Visualisation/SPC/v1/Individuals",
	component: SPCChart,
	// Exclude duplicates: the canonical v1 Individuals stories live in SPCChart/.
	includeStories: [],
	argTypes: {
		trendVisualMode: {
			control: { type: 'select' },
