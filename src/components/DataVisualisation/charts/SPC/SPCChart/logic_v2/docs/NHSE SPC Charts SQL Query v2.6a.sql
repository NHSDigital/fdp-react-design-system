...
-- 2.5        05/12/2022    SQL Server 2012    Matthew Callus    Corrected data gaps in XmR charts not displaying in Power BI template
--                                                                   � Updated [PointRank] to use DATEDIFF when [ChartType] is 'XmR'
-- 2.6        10/01/2024    SQL Server 2012    Matthew Callus    Updated default settings
--                                                                   � Changed @SettingMinimumPoints to 13
--                                                                   � Changed @SettingSpecialCauseShiftPoints default to 6
--                                                                   � Changed @SettingSpecialCauseTrendPoints default to 6
--                                                               Updated logic for two-to-three sigma special cause rule, allowing points beyond three-sigma to count
--                                                                   � Renamed Step 4I
--                                                                   � Renamed columns
--                                                                         � Renamed [SpecialCauseTwoThreeSigmaAboveMeanFlag] to [SpecialCauseTwoSigmaAboveMeanFlag]
--                                                                         � Renamed [SpecialCauseTwoThreeSigmaBelowMeanFlag] to [SpecialCauseTwoSigmaBelowMeanFlag]
--                                                                         � Renamed [SpecialCauseTwoThreeSigmaAboveMeanStartFlag] to [SpecialCauseTwoSigmaAboveMeanStartFlag]
--                                                                         � Renamed [SpecialCauseTwoThreeSigmaBelowMeanStartFlag] to [SpecialCauseTwoSigmaBelowMeanStartFlag]
--                                                                         � Renamed [SpecialCauseTwoThreeSigmaAboveMeanStartFlagCount] to [SpecialCauseTwoSigmaAboveMeanStartFlagCount]
--                                                                         � Renamed [SpecialCauseTwoThreeSigmaBelowMeanStartFlagCount] to [SpecialCauseTwoSigmaBelowMeanStartFlagCount]
--                                                                         � Renamed [SpecialCauseRuleTwoThreeSigmaAboveMeanFlag] to [SpecialCauseRuleTwoSigmaAboveMeanFlag]
--                                                                         � Renamed [SpecialCauseRuleTwoThreeSigmaBelowMeanFlag] to [SpecialCauseRuleTwoSigmaBelowMeanFlag]
--                                                                   � Renamed temporary tables
--                                                                         � Renamed #SPCCalculationsSpecialCauseTwoThreeSigmaPrep to #SPCCalculationsSpecialCauseTwoSigmaPrep
--                                                                         � Renamed #SPCCalculationsSpecialCauseTwoThreeSigmaStartFlag to #SPCCalculationsSpecialCauseTwoSigmaStartFlag
--                                                                         � Renamed #SPCCalculationsSpecialCauseTwoThreeSigmaStartFlagCount to #SPCCalculationsSpecialCauseTwoSigmaStartFlagCount
--                                                                         � Renamed #SPCCalculationsSpecialCauseTwoThreeSigma to #SPCCalculationsSpecialCauseTwoSigma
--
--====================================================================================================================================================================================================--
-- STEP 1: SETUP
--====================================================================================================================================================================================================--
...
IF OBJECT_ID('tempdb..#SPCCalculationsSpecialCauseTwoSigmaPrep')                IS NOT NULL DROP TABLE #SPCCalculationsSpecialCauseTwoSigmaPrep
IF OBJECT_ID('tempdb..#SPCCalculationsSpecialCauseTwoSigmaStartFlag')           IS NOT NULL DROP TABLE #SPCCalculationsSpecialCauseTwoSigmaStartFlag
IF OBJECT_ID('tempdb..#SPCCalculationsSpecialCauseTwoSigmaStartFlagCount')      IS NOT NULL DROP TABLE #SPCCalculationsSpecialCauseTwoSigmaStartFlagCount
IF OBJECT_ID('tempdb..#SPCCalculationsSpecialCauseTwoSigma')                    IS NOT NULL DROP TABLE #SPCCalculationsSpecialCauseTwoSigma
...
IF OBJECT_ID('tempdb..#Warnings')                                               IS NOT NULL DROP TABLE #Warnings
IF OBJECT_ID('tempdb..#ConflictRanking')                                        IS NOT NULL DROP TABLE #ConflictRanking
IF OBJECT_ID('tempdb..#ConflictRankingSummary')                                 IS NOT NULL DROP TABLE #ConflictRankingSummary
...
DECLARE @SettingSpecialCauseShiftPoints INT = 6
...
DECLARE @SettingSpecialCauseTrendPoints INT = 6
...
-- ('1' = on | '0' = off)
DECLARE @SettingGlobalWarnings BIT = 0
...
DECLARE @SettingMinimumPoints INT = 13
...
INSERT INTO #RawData VALUES ('M1', 'Department C', 'TOTAL'       , NULL, NULL, NULL, '20210322', 0.898, 0, 0, 'Two out of three points beyond two-sigma with the other point on the same side of the mean')
...
INSERT INTO #RawData VALUES ('M1', 'Department C', 'TOTAL'       , NULL, NULL, NULL, '20210614', 0.923, 0, 0, 'Three out of three points beyond two-sigma')
...
INSERT INTO #RawData VALUES ('M8', 'Category 2b', 'Category 2', NULL, NULL    , NULL        , '20210301',  81, 0, 0, NULL)
    ...
    -- Example of populating from a table:
        ...
        -- INSERT INTO #RawData
        -- SELECT <the eleven columns needed, in the correct order, with suitable data types>
        -- FROM <source table>
        -- WHERE <optional conditions>

    -- Example of populating from a stored procedure that only returns the eleven columns needed, in the correct order, with suitable data types:

        -- INSERT INTO RawData
        -- EXEC <stored procedure>

    -- Example of populating from a stored procedure that returns additional columns, or the eleven columns needed in a different order:
...
SELECT   [RowID]                              = CASE WHEN m.[ChartType] = 'T'          THEN CONCAT(r.[MetricID], '||', h.[GroupHierarchy], '||', r.[Group], '||', ISNULL(r.[Filter1], '< No Filter >'), '||', ISNULL(r.[Filter2], '< No Filter >'), '||', ROW_NUMBER()  OVER(PARTITION BY m.[MetricOrder], h.[GroupOrder], r.[Filter1], r.[Filter2]                ORDER BY r.[Date]) - 1)
      ...
      ,  [PointRank]                          = CASE WHEN m.[ChartType] = 'T'          THEN                                                                                                                                                               ROW_NUMBER()  OVER(PARTITION BY m.[MetricOrder], h.[GroupOrder], r.[Filter1], r.[Filter2]                ORDER BY r.[Date]) - 1
                                                     WHEN m.[ChartType] = 'G'          THEN                                                                                                                                                               ROW_NUMBER()  OVER(PARTITION BY m.[MetricOrder], h.[GroupOrder], r.[Filter1], r.[Filter2]                ORDER BY r.[Date])
                                                                                       ELSE                                                                                                                                                 DATEDIFF(DAY, MIN(r.[Date]) OVER(PARTITION BY m.[MetricOrder], h.[GroupOrder], r.[Filter1], r.[Filter2]                                 ), r.[Date]) + 1 END
...
--====================================================================================================================================================================================================--
-- STEP 4I: SPECIAL CAUSE - TWO-SIGMA
--====================================================================================================================================================================================================--
--
-- Leave this step as it is
--
-- This step calculates points that trigger the special cause rule for there being two or three points within a run of three that lie beyond the two-sigma line on a consistent side of the mean
-- All three points in the run must be on the same side of the mean
--
--====================================================================================================================================================================================================--
...
SELECT *
      ,[SpecialCauseTwoSigmaAboveMeanFlag] = CASE WHEN [GhostFlag] = 1                THEN 0
                                                  WHEN [Value] > [UpperTwoSigma]      THEN 1
                                                                                           ELSE 0 END
      ,[SpecialCauseTwoSigmaBelowMeanFlag] = CASE WHEN [GhostFlag] = 1                THEN 0
                                                  WHEN [Value] < [LowerTwoSigma]      THEN 1
                                                                                           ELSE 0 END
INTO #SPCCalculationsSpecialCauseTwoSigmaPrep
FROM #SPCCalculationsSpecialCauseTrend

-- Determine each non-ghosted point that is flagged and starts a group of two or three non-ghosted two-sigma points, all on the same side of the mean, within a run of three, within metric/group/filter/partition combination
-- All three points must be on the same side of the mean
SELECT *
      ,[SpecialCauseTwoSigmaAboveMeanStartFlag] = CASE WHEN [SpecialCauseTwoSigmaAboveMeanFlag] = 1
                                                        AND ( LEAD([SpecialCauseTwoSigmaAboveMeanFlag], 1) OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date]) = 1
                                                        ...
                                                        OR    LEAD([SpecialCauseTwoSigmaAboveMeanFlag], 2) OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date]) = 1
                                                         AND  LEAD([SpecialCauseAboveMeanFlag], 1)         OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date]) = 1)  THEN 1
                                                                                                                                                                                            ELSE 0 END
      ,[SpecialCauseTwoSigmaBelowMeanStartFlag] = CASE WHEN [SpecialCauseTwoSigmaBelowMeanFlag] = 1
                                                        AND ( LEAD([SpecialCauseTwoSigmaBelowMeanFlag], 1) OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date]) = 1
                                                        ...
                                                        OR    LEAD([SpecialCauseTwoSigmaBelowMeanFlag], 2) OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date]) = 1
                                                         AND  LEAD([SpecialCauseBelowMeanFlag], 1)         OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date]) = 1)  THEN 1
                                                                                                                                                                                            ELSE 0 END
INTO #SPCCalculationsSpecialCauseTwoSigmaStartFlag
FROM #SPCCalculationsSpecialCauseTwoSigmaPrep

-- Add cumulative sum of the above and below mean start-of-two-sigma flags for non-ghosted points within metric/group/filter/partition combination
SELECT *
      ,[SpecialCauseTwoSigmaAboveMeanStartFlagCount] = SUM([SpecialCauseTwoSigmaAboveMeanStartFlag]) OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date])
      ,[SpecialCauseTwoSigmaBelowMeanStartFlagCount] = SUM([SpecialCauseTwoSigmaBelowMeanStartFlag]) OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date])
INTO #SPCCalculationsSpecialCauseTwoSigmaStartFlagCount
FROM #SPCCalculationsSpecialCauseTwoSigmaStartFlag

-- Determine each non-ghosted two-sigma point within a group of two or three non-ghosted two-sigma points, on the same side of the mean
-- This is done by comparing the above/below mean start-of-two-sigma flag count with that 3 non-ghosted points prior within metric/group/filter/partition combination, replacing NULL for zero when LAG goes back too far
-- [SpecialCauseTwoSigmaAboveMeanStartFlagCount] or [SpecialCauseTwoSigmaBelowMeanStartFlagCount] will only be higher if there is at least one point within the last 2 non-ghosted points within metric/group/filter/partition combination that starts a new group
-- The point itself must also be flagged
SELECT *
      ,[SpecialCauseRuleTwoSigmaAboveMeanFlag] = CASE WHEN [SpecialCauseTwoSigmaAboveMeanFlag] = 1
                                                       AND [SpecialCauseTwoSigmaAboveMeanStartFlagCount] > ISNULL(LAG([SpecialCauseTwoSigmaAboveMeanStartFlagCount], 3) OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date]), 0) THEN 1
                                                                                                                                                                                                                                                       ELSE 0 END
      ,[SpecialCauseRuleTwoSigmaBelowMeanFlag] = CASE WHEN [SpecialCauseTwoSigmaBelowMeanFlag] = 1
                                                       AND [SpecialCauseTwoSigmaBelowMeanStartFlagCount] > ISNULL(LAG([SpecialCauseTwoSigmaBelowMeanStartFlagCount], 3) OVER(PARTITION BY [ChartID], [PartitionIDExcludeGhosting] ORDER BY [Date]), 0) THEN 1
                                                                                                                                                                                                                                                       ELSE 0 END
INTO #SPCCalculationsSpecialCauseTwoSigma
FROM #SPCCalculationsSpecialCauseTwoSigmaStartFlagCount

-- Print message for end of step
SET @PrintMessage = CONVERT(VARCHAR(12), GETDATE(), 14) + ': Step 4i complete, special cause: two-sigma'
RAISERROR(@PrintMessage, 0, 1) WITH NOWAIT
...
SELECT *
      ,[SpecialCauseImprovementValue] = CASE WHEN [MetricImprovement] = 'Up'
                                              AND ([SpecialCauseRuleSinglePointAboveUpperProcessLimitFlag]    = 1
                                                   ...
                                                   OR [SpecialCauseRuleTwoSigmaAboveMeanFlag]                 = 1) THEN [Value]
                                             WHEN [MetricImprovement] = 'Down'
                                              AND ([SpecialCauseRuleSinglePointBelowLowerProcessLimitFlag]    = 1
                                                   ...
                                                   OR [SpecialCauseRuleTwoSigmaBelowMeanFlag]                 = 1) THEN [Value] END
      ,[SpecialCauseConcernValue]     = CASE WHEN [MetricImprovement] = 'Up'
                                              AND ([SpecialCauseRuleSinglePointBelowLowerProcessLimitFlag]    = 1
                                                   OR [SpecialCauseRuleShiftBelowMeanFlag]                    = 1
                                                   OR [SpecialCauseRuleTrendDecreasingFlag]                   = 1
                                                   OR [SpecialCauseRuleTwoSigmaBelowMeanFlag]                 = 1) THEN [Value]
                                             WHEN [MetricImprovement] = 'Down'
                                              AND ([SpecialCauseRuleSinglePointAboveUpperProcessLimitFlag]    = 1
                                                   OR [SpecialCauseRuleShiftAboveMeanFlag]                    = 1
                                                   OR [SpecialCauseRuleTrendIncreasingFlag]                   = 1
                                                   OR [SpecialCauseRuleTwoSigmaAboveMeanFlag]                 = 1) THEN [Value] END
      ...
      ,[SpecialCauseNeitherValue]      = CASE WHEN [MetricImprovement] = 'Neither'
                                              AND ([SpecialCauseRuleSinglePointAboveUpperProcessLimitFlag]    = 1
                                                   ...
                                                   OR [SpecialCauseRuleTrendIncreasingFlag]                   = 1
                                                   OR [SpecialCauseRuleTrendDecreasingFlag]                   = 1
                                                   OR [SpecialCauseRuleTwoSigmaAboveMeanFlag]                 = 1
                                                   OR [SpecialCauseRuleTwoSigmaBelowMeanFlag]                 = 1) THEN [Value] END
      ,[SpecialCauseNeitherHighFlag]  = CASE WHEN [MetricImprovement] = 'Neither'
                                              AND ([SpecialCauseRuleSinglePointAboveUpperProcessLimitFlag]    = 1
                                                   OR [SpecialCauseRuleShiftAboveMeanFlag]                    = 1
                                                   OR [SpecialCauseRuleTrendIncreasingFlag]                   = 1
                                                   OR [SpecialCauseRuleTwoSigmaAboveMeanFlag]                 = 1) THEN 1
                                                                                                                   ELSE 0 END
      ,[SpecialCauseNeitherLowFlag]   = CASE WHEN [MetricImprovement] = 'Neither'
                                              AND ([SpecialCauseRuleSinglePointBelowLowerProcessLimitFlag]    = 1
                                                   OR [SpecialCauseRuleShiftBelowMeanFlag]                    = 1
                                                   OR [SpecialCauseRuleTrendDecreasingFlag]                   = 1
                                                   OR [SpecialCauseRuleTwoSigmaBelowMeanFlag]                 = 1) THEN 1
                                                                                                                   ELSE 0 END
INTO #SPCCalculationsSpecialCauseCombined
FROM #SPCCalculationsSpecialCauseTwoSigma
...
--Determine all the special cause rules that apply for each row, and assign a numeric value based on primacy rules (trend, shift, 2 out of 3, single point)
SELECT 
	 RowID
	,case when [SpecialCauseRuleSinglePointAboveUpperProcessLimitFlag] = 1 then 1 else 0 end UpwardsRank
	,case when [SpecialCauseRuleSinglePointBelowLowerProcessLimitFlag] = 1 then 1 else 0 end DownwardsRank
INTO #ConflictRanking 
FROM #SPCCalculationsSpecialCauseCombined 
WHERE [SpecialCauseImprovementValue] IS NOT NULL AND [SpecialCauseConcernValue] IS NOT NULL AND ([SpecialCauseRuleSinglePointAboveUpperProcessLimitFlag] = 1 or [SpecialCauseRuleSinglePointBelowLowerProcessLimitFlag] = 1)
	union all
SELECT 
	 RowID
	,case when [SpecialCauseRuleTwoSigmaAboveMeanFlag] = 1 then 2 else 0 end UpwardsRank
	,case when [SpecialCauseRuleTwoSigmaBelowMeanFlag] = 1 then 2 else 0 end DownwardsRank
FROM #SPCCalculationsSpecialCauseCombined 
WHERE [SpecialCauseImprovementValue] IS NOT NULL AND [SpecialCauseConcernValue] IS NOT NULL AND ([SpecialCauseRuleTwoSigmaAboveMeanFlag] = 1 or [SpecialCauseRuleTwoSigmaBelowMeanFlag] = 1)
	union all
SELECT 
	 RowID
	,case when [SpecialCauseRuleShiftAboveMeanFlag] = 1 then 3 else 0 end UpwardsRank
	,case when [SpecialCauseRuleShiftBelowMeanFlag] = 1 then 3 else 0 end DownwardsRank
FROM #SPCCalculationsSpecialCauseCombined 
WHERE [SpecialCauseImprovementValue] IS NOT NULL AND [SpecialCauseConcernValue] IS NOT NULL AND ([SpecialCauseRuleShiftAboveMeanFlag] = 1 or [SpecialCauseRuleShiftBelowMeanFlag] = 1)
	union all
SELECT 
	 RowID
	,case when [SpecialCauseRuleTrendIncreasingFlag] = 1 then 4 else 0 end UpwardsRank
	,case when [SpecialCauseRuleTrendDecreasingFlag] = 1 then 4 else 0 end DownwardsRank
FROM #SPCCalculationsSpecialCauseCombined 
WHERE [SpecialCauseImprovementValue] IS NOT NULL AND [SpecialCauseConcernValue] IS NOT NULL AND ([SpecialCauseRuleTrendIncreasingFlag] = 1 or [SpecialCauseRuleTrendDecreasingFlag] = 1)

----***For testing
--select * from #ConflictRanking where RowID = '257||1||MECCS||< No Filter >||< No Filter >||12'

--Determine which special cause rule (and direction) has primacy 
SELECT
       RowID
      ,case 
            when Max(UpwardsRank) > Max(DownwardsRank) then 'Upwards' 
            when Max(UpwardsRank) = Max(DownwardsRank) then 'Same'
			when Max(DownwardsRank) > Max(UpwardsRank) then 'Downwards' 
       end PrimeDirection
INTO #ConflictRankingSummary
FROM #ConflictRanking
GROUP BY RowID

----***For testing
--select * from #ConflictRankingSummary where RowID = '257||1||MECCS||< No Filter >||< No Filter >||12'

--Use the PrimeDirection combened with Improvmeent Direction to determine if SpecialCauseConcernValue and SpecialCauseImprovementValue should be kept.  Also set conflict flag
update  #SPCCalculationsSpecialCauseCombined
set SpecialCauseConcernValue =
                        case 
                              when PrimeDirection = 'Upwards' and MetricImprovement = 'Up' then NULL 
                              when PrimeDirection = 'Upwards' and MetricImprovement = 'Down' then SpecialCauseConcernValue
                              when PrimeDirection = 'Downwards' and MetricImprovement = 'Up' then SpecialCauseConcernValue
                              when PrimeDirection = 'Downwards' and MetricImprovement = 'Down' then NULL
                              when PrimeDirection = 'Same' and [MetricConflictRule] = 'Improvement' then NULL
                              when PrimeDirection = 'Same' and [MetricConflictRule] = 'Concern' then SpecialCauseConcernValue
                        end,
SpecialCauseImprovementValue = 
                        case 
                              when PrimeDirection = 'Upwards' and MetricImprovement = 'Up' then SpecialCauseImprovementValue  
                              when PrimeDirection = 'Upwards' and MetricImprovement = 'Down' then NULL
                              when PrimeDirection = 'Downwards' and MetricImprovement = 'Up' then NULL
                              when PrimeDirection = 'Downwards' and MetricImprovement = 'Down' then SpecialCauseImprovementValue
                              when PrimeDirection = 'Same' and [MetricConflictRule] = 'Improvement' then SpecialCauseImprovementValue
                              when PrimeDirection = 'Same' and [MetricConflictRule] = 'Concern' then NULL
                        end ,
[SpecialCauseConflictFlag] = 1
FROM #SPCCalculationsSpecialCauseCombined y
      LEFT JOIN #ConflictRankingSummary x on x.RowID = y.RowID
WHERE [SpecialCauseImprovementValue] IS NOT NULL AND [SpecialCauseConcernValue] IS NOT NULL 


----***For testing
--select 
--[SpecialCauseConcernValue], SpecialCauseImprovementValue, MetricImprovement, [SpecialCauseRuleSinglePointAboveUpperProcessLimitFlag], [SpecialCauseRuleSinglePointBelowLowerProcessLimitFlag],
--[SpecialCauseRuleTwoSigmaAboveMeanFlag], [SpecialCauseRuleTwoSigmaBelowMeanFlag],
--[SpecialCauseRuleShiftAboveMeanFlag], [SpecialCauseRuleShiftBelowMeanFlag],
--[SpecialCauseRuleTrendIncreasingFlag], [SpecialCauseRuleTrendDecreasingFlag], y.*
--FROM #SPCCalculationsSpecialCauseCombined y
--WHERE SpecialCauseConflictFlag = 1 --and RowID = '257||1||MECCS||< No Filter >||< No Filter >||12'
...
-- [PointRank]                                                Text           6: Output     4b                   ROW_NUMBER if [ChartType] not 'XmR'; calculated from [Date] if [ChartType] = 'XmR'
...
-- [SpecialCauseNeitherHighFlag]                              Number         No            4j                   Calculated from [MetricImprovement], [SpecialCauseRuleShiftAboveMeanFlag], [SpecialCauseRuleSinglePointAboveUpperProcessLimitFlag], [SpecialCauseRuleTrendIncreasingFlag], and [SpecialCauseRuleTwoSigmaAboveMeanFlag]: 1 or 0
-- [SpecialCauseNeitherLowFlag]                               Number         No            4j                   Calculated from [MetricImprovement], [SpecialCauseRuleShiftBelowMeanFlag], [SpecialCauseRuleSinglePointBelowLowerProcessLimitFlag], [SpecialCauseRuleTrendDecreasingFlag], and [SpecialCauseRuleTwoSigmaBelowMeanFlag]: 1 or 0
...
-- [SpecialCauseRuleTwoSigmaAboveMeanFlag]                    Number         No            4i                   Calculated from [SpecialCauseTwoSigmaAboveMeanFlag] and [SpecialCauseTwoigmaAboveMeanStartFlagCount]: 1 or 0
-- [SpecialCauseRuleTwoSigmaBelowMeanFlag]                    Number         No            4i                   Calculated from [SpecialCauseTwoSigmaBelowMeanFlag] and [SpecialCauseTwoigmaBelowMeanStartFlagCount]: 1 or 0
...
-- [SpecialCauseTwoSigmaAboveMeanFlag]                        Number         No            4i                   Calculated from [UpperProcessLimit], [UpperTwoSigma] and [Value]: 1 or 0: 0 if [GhostFlag] = 1
-- [SpecialCauseTwoSigmaAboveMeanStartFlag]                   Number         No            4i                   Calculated from [SpecialCauseAboveMeanFlag] and [SpecialCauseTwoSigmaAboveMeanFlag]: 1 or 0
-- [SpecialCauseTwoSigmaAboveMeanStartFlagCount]              Number         No            4i                   Calculated from [SpecialCauseTwoSigmaAboveMeanStartFlag]
-- [SpecialCauseTwoSigmaBelowMeanFlag]                        Number         No            4i                   Calculated from [LowerProcessLimit], [LowerTwoSigma] and [Value]: 1 or 0: 0 if [GhostFlag] = 1
-- [SpecialCauseTwoSigmaBelowMeanStartFlag]                   Number         No            4i                   Calculated from [SpecialCauseBelowMeanFlag] and [SpecialCauseTwoSigmaBelowMeanFlag]: 1 or 0
-- [SpecialCauseTwoSigmaBelowMeanStartFlagCount]              Number         No            4i                   Calculated from [SpecialCauseTwoSigmaBelowMeanStartFlag]
