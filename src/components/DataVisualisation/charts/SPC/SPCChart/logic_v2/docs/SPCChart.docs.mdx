...
import {
  ...
  type SPCChartProps,
  type SPCDatum,
} from '@fergusbisset/nhs-fdp-design-system/components/DataVisualisation/charts/SPC/SPCChart/SPCChart.props';
```
...
```tsx
import { computeSpcPrecomputed, ImprovementDirection, ChartType, DEFAULT_MIN_POINTS } from '@fergusbisset/nhs-fdp-design-system/components/DataVisualisation/charts/SPC';
