...
import {
  ...
  type SPCChartProps,
  type SPCDatum,
} from '@nhsdigital/fdp-design-system/components/DataVisualisation/charts/SPC/SPCChart/SPCChart.props';
```
...
```tsx
import { computeSpcPrecomputed, ImprovementDirection, ChartType, DEFAULT_MIN_POINTS } from '@nhsdigital/fdp-design-system/components/DataVisualisation/charts/SPC';
