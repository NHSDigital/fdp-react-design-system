...
Status: planned (not implemented in current v2 engine). The diagram below describes the intended design. Today, the engine does not insert baselines automatically; use explicit baselines in your data/props to create new partitions.
