...
import TrendSegmentationHighIsGoodExample from './examples/TrendSegmentation.HighIsGoodExample';

<Meta title="Data Visualisation/SPC/Guides/Trend segmentation and special-cause conflicts"/>
...
<div style={{ marginTop: 12, marginBottom: 8 }}>
  <strong>Embedded example (High is good):</strong>
</div>
<TrendSegmentationHighIsGoodExample />
