...
import SPCRetroOverlayToggleDemo from '../doc-examples/SPCRetroOverlayToggleDemo';

<Meta title="Data Visualisation/SPC/Guides/Retro Overlay"/>
...
## Interactive example: Toggle teaching overlay

This live demo shows a NHS Button that toggles the retro overlay on and off. The chart remains engine‑true; the overlay is reflected in the table and explanatory banner to emphasise it’s a teaching‑only layer.
