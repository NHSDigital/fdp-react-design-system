...
export const healthcareDatasets = [
  ...
  },
  {
    ...
    unit: "days",
    description: "Gradual improvement with downward shift after month 12; lower is better.",
    values: [
  ...
  },
  {
    ...
    direction: "down" as const,
    unit: "%",
    description: "Concern cluster (two-of-three) and an elevated outlier; lower is better.",
    values: [
  ...
  },
  {
    ...
    direction: "up" as const,
    unit: "%",
    description: "High-performing shift then a single concern dip; higher is better.",
    values: [
  ...
  },
  {
    ...
    direction: "down" as const,
    unit: "",
    description: "Downward trend with one special-cause high point; lower is better.",
    values: [
