  ...
  render: (args) => {
    return (
      <div style={{ display: "grid", gap: 12 }}>
        <p style={{ margin: 0 }}>
          Use mouse hover or keyboard arrows (Left/Right) over the chart to move focus. The Signals
          Inspector below mirrors the focused point and lists the detected rules.
        </p>
        <SPCChart {...args} />
      </div>
    );
