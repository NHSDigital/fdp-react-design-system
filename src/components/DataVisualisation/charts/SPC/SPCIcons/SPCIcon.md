...
```ts
import { SPCVariationIcon, SPCAssuranceIcon } from '@nhsdigital/fdp-design-system';
```
...
```ts
import { SPC } from '@nhsdigital/fdp-design-system/components/DataVisualisation';
...
```ts
import { SPCVariationIcon, SPCAssuranceIcon, VariationJudgement, MetricPolarity } from '@nhsdigital/fdp-design-system/components/DataVisualisation/charts/SPC';
```
...
```ts
import { SPCVariationIcon } from '@nhsdigital/fdp-design-system/src/components/DataVisualisation/charts/SPC/SPCIcons/SPCIcon';
```
...
```ts
import { SPCVariationIcon } from '@nhsdigital/fdp-design-system/ssr';
```
...
```ts
import { SPCVariationIcon } from '@nhsdigital/fdp-design-system/pure';
```
...
import '@nhsdigital/fdp-design-system/components/DataVisualisation/css';
```
...
```ts
import { VariationJudgement, MetricPolarity, Direction } from '@nhsdigital/fdp-design-system/components/DataVisualisation/charts/SPC';
```
