...
Variation and assurance icons are gated by `settings.minimumPoints` (default 13) requiring enough non‑ghost points to form stable limits; otherwise embedded icons are hidden.
