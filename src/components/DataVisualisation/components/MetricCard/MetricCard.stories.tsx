...
const meta: Meta<typeof MetricCard> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Modern KPI card with DataViz-inspired styling. Features left border accents, subtle gradients, and comprehensive delta indicators for effective data presentation.'
      }
    }
  },
  argTypes: {
...
export const WithInvertedDelta: Story = {
  args: { 
    ...
    value: 1.2, 
    unit: '%', 
    delta: { value: -0.2, isPercent: true, invert: true, period: 'vs last month' }, 
    status: 'positive',
    variant: 'success'
  }
};
      ...
      <Row style={{ marginTop: '2rem' }}>
        <Column width='one-quarter'>
          <MetricCard 
            ...
            unit="%" 
            variant="success"
            delta={{ value: -0.2, isPercent: true, invert: true, period: "this month" }} 
            status="positive" 
          />
        </Column>
        <Column width='one-quarter'>
