...
<Meta title="Data Visualisation/SPC/SPCMetricCard/Documentation" />
...
- Metadata: a "Latest: …" string formatted from the inferred/supplied period
...
See stories under "Data Visualisation/SPC/SPCMetricCard":
