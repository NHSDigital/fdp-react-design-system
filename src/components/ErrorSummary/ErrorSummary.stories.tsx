...
export const AppointmentBookingErrors: Story = {
  args: {
    titleText: 'There is a problem',
    errorList: [
      {
        text: 'Select your preferred appointment date',
  ...
  parameters: {
    docs: {
      description: {
        story: 'NHS appointment booking form validation errors.',
      },
    },
  },
};

export const ContactPreferencesError: Story = {
  args: {
    titleText: 'There is a problem',
    errorList: [
      {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Contact preferences form with checkbox and input validation errors.',
      },
    },
  },
};

export const MedicalHistoryErrors: Story = {
  args: {
    titleText: 'There is a problem',
    errorList: [
      {
        text: 'Select if you have any allergies',
        href: '#allergies-yes'
      },
      {
        text: 'Enter details of your current medications',
        href: '#current-medications'
      },
      {
        text: 'Medical history must be 10 characters or more',
  ...
  parameters: {
    docs: {
      description: {
        story: 'Medical history form with radio, textarea, and validation length errors.',
      },
    },
  },
};
...
export const WithCustomClass: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Error summary with custom CSS class applied.',
      },
    },
  },
};
