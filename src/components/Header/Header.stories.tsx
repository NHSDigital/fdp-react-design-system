...
export const AccessibilityDemo: Story = {
  args: {
    ...
    navigation: {
      ...
      items: [
        ...
        {
          href: '#',
          html: '<abbr title="Web Content Accessibility Guidelines">WCAG</abbr> compliance'
        },
        {
          href: '#',
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstration of accessibility features including proper ARIA labels, semantic HTML, and keyboard navigation support. Try tabbing through the navigation elements.'
      }
    }
  }
};
