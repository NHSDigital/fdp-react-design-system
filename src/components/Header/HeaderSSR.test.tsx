...
// Deprecated legacy SSR test file trimmed to placeholder (real coverage in Header.ssr.test.tsx)
describe('HeaderSSR (legacy deprecated)', () => { it('placeholder', () => { expect(true).toBe(true); }); });
