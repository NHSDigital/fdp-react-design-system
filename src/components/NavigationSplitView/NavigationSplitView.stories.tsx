...
const meta: Meta<typeof NavigationSplitView< string, DemoItem>> = {
  ...
  args: {
    ...
    ,secondarySubheader: (item: DemoItem) => (
      <span style={{ fontSize: 14 }}>Metrics for {item.label}</span>
    )
  },
  argTypes: {
    ...
    contentSubheader: { control: false, description: 'Optional subheader beneath the content heading (function or ReactNode)' },
    secondarySubheader: { control: false, description: 'Optional subheader heading for tertiary (secondary) pane (function or ReactNode)' }
  },
  parameters: {
    layout: 'fullscreen',
    docs: {
