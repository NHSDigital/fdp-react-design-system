...
import '@fergusbisset/nhs-fdp-design-system/components/AriaTabsDataGrid/css';

// Option 2: Full design system styles
    ...
    <div className="nhsuk-width-container">
      <div className="nhsuk-grid-row">
        <div className="nhsuk-grid-column-full">
          <h1 className="nhsuk-heading-l">Data Management</h1>
          <AriaTabsDataGrid
            tabPanels={tabPanels}
...
// Styles still need to be imported separately
import '@fergusbisset/nhs-fdp-design-system/css';
```
...
**SSR hydration mismatch**: Use the SSR entry point for server-side rendering:
```tsx
import '@fergusbisset/nhs-fdp-design-system/ssr';
```
