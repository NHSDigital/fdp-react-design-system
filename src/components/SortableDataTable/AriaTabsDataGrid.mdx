...
// Import styles (on a component by component basis, if you haven't already imported all styles) from '@nhsdigital/fdp-design-system/css'
import '@nhsdigital/fdp-design-system/components/SortableDataTable/css'; // The styles for the Table itself
import '@nhsdigital/fdp-design-system/components/SortableDataTable/SortStatusControl/css'; // The styles for the sort status control
import '@nhsdigital/fdp-design-system/components/Button/css'; // The styles for the NHS Buttons
...
import { AriaTabsDataGrid } from '@nhsdigital/fdp-design-system/components/SortableDataTable';
...
import { AriaTabsDataGrid } from '@nhsdigital/fdp-design-system';
...
import '@nhsdigital/fdp-design-system/core'; // ~55kB (layout essentials)
...
const AriaTabsDataGrid = lazy(() => 
  import('@nhsdigital/fdp-design-system').then(module => ({
