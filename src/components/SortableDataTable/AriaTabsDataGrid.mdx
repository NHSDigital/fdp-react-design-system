...
// Import styles (on a component by component basis, if you haven't already imported all styles) from '@nhsdigital/nhs-fdp-design-system/css'
import '@nhsdigital/nhs-fdp-design-system/components/SortableDataTable/css'; // The styles for the Table itself
import '@nhsdigital/nhs-fdp-design-system/components/SortableDataTable/SortStatusControl/css'; // The styles for the sort status control
import '@nhsdigital/nhs-fdp-design-system/components/Button/css'; // The styles for the NHS Buttons
...
import { AriaTabsDataGrid } from '@nhsdigital/nhs-fdp-design-system/components/SortableDataTable';
...
import { AriaTabsDataGrid } from '@nhsdigital/nhs-fdp-design-system';
...
import '@nhsdigital/nhs-fdp-design-system/core'; // ~55kB (layout essentials)
...
const AriaTabsDataGrid = lazy(() => 
  import('@nhsdigital/nhs-fdp-design-system').then(module => ({
