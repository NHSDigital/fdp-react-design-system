...
import { ImprovementDirection, VariationIcon, type SpcRowV2 } from "../../src/components/DataVisualisation/charts/SPC/SPCChart/logic_v2/types";
import { computeSpcVisualCategories, SpcVisualCategory } from "../../src/components/DataVisualisation/charts/SPC/SPCChart/logic_v2/postprocess/visualCategories";
...
describe("computeSpcVisualCategories", () => {
  ...
  it("Ungated: colours directional by metricImprovement on Neither", () => {
    const upRows = [row({ variationIcon: VariationIcon.NeitherHigh, shiftUp: true })];
    ...
    const downRows = [row({ variationIcon: VariationIcon.NeitherLow, shiftDown: true })];
