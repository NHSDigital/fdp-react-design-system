...
/**
 * Visual Testing for Footer Component
...
const testCases: VisualTestConfig[] = [
  {
    "name": "footer - default",
    "storybookPath": "/story/components-footer--default",
    "referencePath": "/footer/footer-default.html"
  },
  {
    "name": "footer - multiColumn",
    "storybookPath": "/story/components-footer--multi-column",
    "referencePath": "/footer/footer-multiColumn.html"
  }
];
