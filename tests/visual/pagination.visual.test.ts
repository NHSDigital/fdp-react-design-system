...
/**
 * Visual Testing for Pagination Component
...
const testCases: VisualTestConfig[] = [
  {
    ...
    "storybookPath": "/story/components-pagination--default",
    "referencePath": "/pagination/pagination-default.html"
  },
  {
    "name": "pagination - nextOnly",
    "storybookPath": "/story/components-pagination--next-only",
    "referencePath": "/pagination/pagination-nextOnly.html"
  }
];
