...
/**
 * Visual Testing for Skip Link Component
 * Compares React implementation against NHS UK reference
 */

const componentName = 'Skip Link Component';
...
const testCases: VisualTestConfig[] = [
  {
    ...
    "storybookPath": "/story/components-skiplink--default",
    "referencePath": "/skiplink/skiplink-default.html"
  }
];
